...
- `cases/dev/04-echelon-beyond.md` — `AGENTS.md`: правила и контракт результата для агента,
  работающего в репозитории.
...
- `cases/dev/04-echelon-beyond.md` — `AGENTS.md`, `TASKS.md`, доска задач с автопостановкой карточек.
